...
public class ANN{
	...
	public ANN(int nI, int nO, int nH, int nPH, double a)
	{
		...
		if(numHidden > 0)
		{
			layers.Add(new Layer2(numNPerHidden, numInputs));

			for(int i = 0; i < numHidden-1; i++)
			{
				layers.Add(new Layer2(numNPerHidden, numNPerHidden));
			}

			layers.Add(new Layer2(numOutputs, numNPerHidden));
		}
		else
		{
			layers.Add(new Layer2(numOutputs, numInputs));
		}
	}
